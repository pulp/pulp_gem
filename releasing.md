...
- If a new minor version (Y) is needed, trigger a [Create New Release Branch](https://github.com/pulp/pulp_gem/actions/workflows/create-branch.yml) job via the GitHub Actions.
