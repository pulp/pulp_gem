...
Publishers contain extra settings for how to publish. You can use a gem publisher on any
repository that contains gem content::

$ http POST $BASE_ADDR/pulp/api/v3/publishers/gem/ name=bar

Response::

    {
        "pulp_href": "http://localhost:24817/pulp/api/v3/repositories/foo/publishers/gem/bar/",
        ...
    }
...
$ http POST $BASE_ADDR/pulp/api/v3/publishers/gem/1/publish/ repository=$BASE_ADDR/pulp/api/v3/repositories/1/
...
Response::
    ...
    {
        "pulp_href": "http://localhost:24817/pulp/api/v3/distributions/1/",
       ...
    }
