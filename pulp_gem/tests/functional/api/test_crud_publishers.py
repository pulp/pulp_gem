...
from pulp_gem.tests.functional.constants import GEM_PUBLISHER_PATH
from pulp_gem.tests.functional.utils import gen_gem_publisher, skip_if
...
class CRUDPublishersTestCase(unittest.TestCase):
    ...
    def test_01_create_publisher(self):
        """Create a publisher."""
        body = gen_gem_publisher()
        type(self).publisher = self.client.post(GEM_PUBLISHER_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(GEM_PUBLISHER_PATH, body)
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(GEM_PUBLISHER_PATH, params={
