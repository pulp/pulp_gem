...
from pulp_gem.tests.functional.constants import DOWNLOAD_POLICIES, GEM_REMOTE_PATH
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def test_01_create_remote(self):
        ...
        type(self).remote = self.client.post(GEM_REMOTE_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(GEM_REMOTE_PATH, body)
    ...
    def test_02_read_remotes(self):
        ...
        page = self.client.get(GEM_REMOTE_PATH, params={"name": self.remote["name"]})
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/PulpQE/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(HTTPError):
            api.Client(config.get_config()).post(GEM_REMOTE_PATH, body)
...
class RemoteDownloadPolicyTestCase(unittest.TestCase):
    ...
    * `Pulp #3763 <https://pulp.plan.io/issues/3763>`_
    ...
    def test_01_no_defined_policy(self):
        ...
        self.remote.update(self.client.post(GEM_REMOTE_PATH, self.body))
